...
/**
 * Response for the getLeadActivies API method.
 *
 * @author Daniel VanMilligan <dan@uxdan.com>
 */
class GetLeadActivitiesResponse extends Response
{
    /**
     * @return array|null contains an array of activites with changes and attributes
     */
